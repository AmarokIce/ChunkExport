...
public class ChunkGetter {
    ...
    private List<ChunkAccess> ChunkGenerator(Level world) {
    ...
    private void randomChunkGenerator(Level world, int chunk, List<ChunkAccess> list) {
        for (int x = 0; x < chunk; x ++) {
            ...
            if (player != null) player.sendSystemMessage(Component.literal("Sampling progress: " + list.size() + "/" + this.maxChunk));
